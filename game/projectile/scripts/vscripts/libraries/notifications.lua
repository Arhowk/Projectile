...
--[[
  ...
  -Additionally, ensure that you have the projectile_notifications.xml, projectile_notifications.js, and projectile_notifications.css files in your panorama content folder.
