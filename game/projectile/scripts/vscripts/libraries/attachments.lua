...
--[[
  ...
  -Additionally, ensure that you have the projectile_attachments.xml, projectile_attachments.js, and projectile_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure projectile)", FCVAR_CHEAT )
